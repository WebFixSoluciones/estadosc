...
@section('contenido')
        <h4 class="tx-gray-800 mg-b-5">Cargar Usuarios</h4>
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            @endif
                <form action="{{route('cargaUsuario_post')}}" method="POST" accept-charset="UTF-8"
                    enctype="multipart/form-data">
                    @csrf
            <div class="form-group">
                <label for="">Cargar Archivo</label>
                <input type="file" name="usuarios" class="form-control">
            </div>
