...
@section('contenido')
    <h4 class="tx-gray-800 mg-b-5">Listado de Categorias</h4>
    <button class="btn btn-success pull-right" data-toggle="modal" data-target="#modaldemo1"> <i
            class="fa fa-plus-circle"></i> Agregar Categoria</button>
                    ...
                    <tbody>
                        @foreach ($categorias as $categoria)
                            <tr>
                                ...
                                <td>
                                    <a href="#" onclick="editarCategoria({{ $categoria->id }})"><i
                                            class="fa fa-edit text-primary"></i></a>
                                    <a href="{{ route('deleteCategoria', $categoria->id) }}"><i
